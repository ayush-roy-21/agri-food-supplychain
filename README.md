...
| **Registry Schema & Exceptions** | `[REGISTRY_SCHEMA.md](file:///e:/Summer%20Internship%2726/agri-food-project/docs/REGISTRY_SCHEMA.md)` | Complete data dictionary for `master_registry.csv` (`26 columns`), `chunk_manifest.csv`, and `exceptions_log.csv` (`401 records`). |
