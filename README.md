...
| **Corpus Architecture & RQs** | `[CORPUS_ARCHITECTURE.md](file:///e:/Summer%20Internship%2726/agri-food-project/docs/CORPUS_ARCHITECTURE.md)` | Details the 11 institutional pillars (`Corpus A` & `Corpus B`), Section 11 Ethics protocol, 152-unit vector matrix engineering, and the Object Anchor Test (`DEC-2026-037`). |
